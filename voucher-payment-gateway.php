...
add_filter('woocommerce_get_checkout_order_received_url', function($url, $order) {
    ...
    // Only police Voucher orders
    if ($order->get_payment_method() !== 'voucher') {
        return $url;
    }

	$wc_status    = $order->get_status();
	$engine_state = $order->get_meta('_voucher_state');
	$success_meta = $order->get_meta('_voucher_payment_success');
